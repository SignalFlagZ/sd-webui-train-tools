            ...
            with gr.Box():
                with gr.Row():
                    ...
                    with gr.Column():
                        ...
                        train_optimizer_type = gr.Dropdown(label="Optimizer type",value=["Lion"], choices=["AdamW", "AdamW8bit", "Lion8bit", "Lion", "SGDNesterov", "SGDNesterov8bit", "DAdaptation","DAdaptAdaGrad", "DAdaptAdam", "DAdaptAdanIP", "DAdaptAdan", "DAdaptLion", "DAdaptSGD", "AdaFactor"], multiselect = True, interactive = True, elem_id="train_optimizer_type")
